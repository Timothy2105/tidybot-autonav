...
ENCODER_MAGNET_OFFSETS = [-630.0 / 4096, 185.0 / 4096, 530.0 / 4096, 1135.0 / 4096]  # Base #7 (IPRL ARX5)

################################################################################
# Teleop and imitation learning

# Base and arm RPC servers
BASE_RPC_HOST = '192.168.1.4'
BASE_RPC_PORT = 50000
ARM_RPC_HOST = '192.168.1.4'
ARM_RPC_PORT = 50001
RPC_AUTHKEY = b'secret password'

# Cameras
BASE_CAMERA_SERIAL = 'A2AE671E'  # Base #7
WRIST_CAMERA_SERIAL = '75EAC51E'  # Base #7
DEPTH_CAMERA_SERIAL = '927523021720'
